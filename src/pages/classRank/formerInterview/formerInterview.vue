<template>
  <div>
    <!-- 工具条 -->
    <el-card class="box-card" v-if="normal">
      <el-form :inline="true" :model="searchBox">
        <el-row>
          <!-- <el-col :span="21" class="Title"> -->
          <span class="TopTitle">走访城市排名检索</span>
          <!-- </el-col> -->
        </el-row>
        <el-row class="selectBoxs">
          ...
          <el-col :span="4">
            <el-form-item prop="searchInput">
              <el-input v-model="searchBox.searchInput" placeholder="城市名称/省份"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
    ...
    <el-card class="box-card" v-if="normal">
      ...
      >
        ...
        <el-table-column prop="city_exception" label="走访次数"></el-table-column>
        <el-table-column prop="city_grading" label="权重分析"></el-table-column>
    ...
    <!-- 查看详情 -->
    <!-- 标题  城市信息 -->
    <el-card class="box-card" v-model="cityDetail" v-if="detail">
      <span>城市详情信息</span>
      <hr />
    ...
    <el-card class="box-card" v-if="detail">
      ...
      >
        ...
        <el-table-column prop="city_score" label="单位名称"></el-table-column>
        <el-table-column prop="city_name" label="单位性质"></el-table-column>
        <el-table-column prop="province" label="年份"></el-table-column>
        <el-table-column prop="city_exception" label="签约总人数"></el-table-column>
        <el-table-column prop="city_grading" label="签约本科"></el-table-column>
        <el-table-column prop="city_grading" label="签约研究生"></el-table-column>
        <el-table-column prop="city_grading" label="签约来校宣讲次数"></el-table-column>
        <el-table-column prop="city_grading" label="走访情况"></el-table-column>
      </el-table>
      <!-- 签约城市列表分页 -->
      <el-pagination
        layout="prev, pager, next"
    ...
    search() {
      ...
      if (
        ...
        this.$ajax({
          method: "post",
          url:
            "http://47.103.10.220:8081/visit/queryVisitByKeyword?education_yon=" +
            education_yon +
            "&city_name=" +
            city_name +
            "&city_visit=" +
